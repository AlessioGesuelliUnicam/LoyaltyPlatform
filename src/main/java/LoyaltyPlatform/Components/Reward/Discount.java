...
public class Discount extends GenericReward {
     ...
     * @throws IllegalArgumentException when the given percentage discount is out of range 1-100
     */
    public void setPercentageDiscount(int percentageDiscount) {
        if(percentageDiscount < 1 || percentageDiscount > 100) throw new IllegalArgumentException("Field percentageDiscount out of range 1-100");
        this.percentageDiscount = percentageDiscount;
    }
